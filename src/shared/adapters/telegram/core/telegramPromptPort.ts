...
import { formatDisplayCardTelegramHtml } from "@/shared/adapters/host/core/formatters/formatDisplayCard.js";
import type { PromptChoice, PromptOptions, PromptPort } from "@/shared/adapters/host/contracts/promptPort.js";
import {
  PROMPT_BACK_LABEL,
  PromptBackError,
  TELEGRAM_BACK_CALLBACK,
} from "@/shared/adapters/host/contracts/promptBack.js";
import {
  createAdapterLogger,
  type AdapterLogger,
} from "@/shared/adapters/host/core/adapterLogger.js";
import type {
  PendingPromptKind,
  TelegramChatSession,
} from "@/shared/adapters/telegram/lib/telegramPromptSession.js";
